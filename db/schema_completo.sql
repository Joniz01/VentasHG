-- =============================================================
-- SCHEMA COMPLETO - VentasHG
-- Ejecutar una sola vez en una base de datos nueva (Neon, Supabase, etc.)
...
-- Catálogo global de extras/presentaciones
...
DO $$ BEGIN
  CREATE TYPE metodo_pago AS ENUM (
    'PUNTO_VENTA', 'TRANSFERENCIA', 'PAGO_MOVIL',
    'EFECTIVO_BS', 'EFECTIVO_USD', 'ZELLE'
  );
...
CREATE INDEX IF NOT EXISTS idx_ventas_pedidos_pendientes ON ventas (despacho_pendiente, pedido_entregado);
CREATE INDEX IF NOT EXISTS idx_ventas_delivery_pagado ON ventas (despacho_pendiente, delivery_pagado);
CREATE INDEX IF NOT EXISTS idx_ventas_cuenta_por_cobrar ON ventas (cuenta_por_cobrar, cuenta_cobrada);
