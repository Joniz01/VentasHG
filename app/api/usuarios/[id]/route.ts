...
export async function PUT(request: NextRequest, { params }: Params) {
  ...
  const permisos =
    body.rol === "ADMIN"
      ? { productos: true, ventas: true, reportes: true, pedidosPendientes: true, descuento: true, dashboard: true, compras: true, eliminarCompras: true, gastos: true, autorizarConteo: true, conteo: true, programarConteo: true, promociones: true }
  ...
  type UpdateOpts = { dashboard: boolean; compras: boolean; eliminarCompras: boolean; gastos: boolean; autorizarConteo: boolean; conteo: boolean; programarConteo: boolean; promociones: boolean };
  ...
  const runUpdate = async (opts: UpdateOpts) => {
    ...
    if (opts.programarConteo) add("ve_programar_conteo", permisos.programarConteo);
  ...
  try {
    ...
    const opts: UpdateOpts = { dashboard: true, compras: true, eliminarCompras: true, gastos: true, autorizarConteo: true, conteo: true, programarConteo: true, promociones: true };
    const columnaPorOpt: Record<keyof UpdateOpts, string> = {
      ...
      conteo: "ve_conteo",
      programarConteo: "ve_programar_conteo",
