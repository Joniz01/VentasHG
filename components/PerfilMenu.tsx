    ...
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-10 z-50 w-80 rounded-lg border border-zinc-200 bg-white shadow-lg">
          ...
          {vista === "clave" && (
            <div className="flex flex-col gap-3 p-4">
              <button onClick={() => { setVista("menu"); setMsg(null); setShowClaveActual(false); setShowClaveNueva(false); setShowClaveConfirm(false); }}
                className="self-start text-xs text-zinc-400 hover:text-zinc-700">
                ← Volver
              </button>
              ...
              <label className="flex flex-col gap-1 text-xs text-zinc-600">
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <button
                    type="button"
                    onClick={() => setShowClaveActual((v) => !v)}
                    ...
                    tabIndex={-1}
                    aria-label={showClaveActual ? "Ocultar clave" : "Ver clave"}
                  >
                    {showClaveActual ? (
              ...
              <label className="flex flex-col gap-1 text-xs text-zinc-600">
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <button
                    type="button"
                    onClick={() => setShowClaveNueva((v) => !v)}
                    style={{ position: "absolute", right: 8, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", padding: 2, color: "var(--erp-text-3)" }}
                    tabIndex={-1}
                    aria-label={showClaveNueva ? "Ocultar clave" : "Ver clave"}
                  >
                    {showClaveNueva ? (
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/>
              ...
              <label className="flex flex-col gap-1 text-xs text-zinc-600">
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <button
                    type="button"
                    onClick={() => setShowClaveConfirm((v) => !v)}
                    style={{ position: "absolute", right: 8, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", padding: 2, color: "var(--erp-text-3)" }}
                    tabIndex={-1}
                    aria-label={showClaveConfirm ? "Ocultar clave" : "Ver clave"}
                  >
                    {showClaveConfirm ? (
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/>
