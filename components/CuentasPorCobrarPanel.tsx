      ...
      <div style={{ background: "var(--erp-surface)", border: "1px solid var(--erp-border)", borderRadius: 12 }} className="p-4 flex flex-col gap-3">
        ...
        <div className="flex flex-wrap items-end gap-3">
          <div className="flex flex-col gap-1">
            ...
            <InputFecha style={{ borderColor: "var(--erp-border)", borderRadius: 8, padding: "6px 10px", fontSize: 14, border: "1px solid var(--erp-border)", background: "var(--erp-surface)", color: "var(--erp-text)" }} value={desde} onChange={(v) => setDesde(v)} />
          </div>
          <div className="flex flex-col gap-1">
            <label style={{ color: "var(--erp-text-2)", fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em" }}>Hasta</label>
            <InputFecha style={{ borderColor: "var(--erp-border)", borderRadius: 8, padding: "6px 10px", fontSize: 14, border: "1px solid var(--erp-border)", background: "var(--erp-surface)", color: "var(--erp-text)" }} value={hasta} onChange={(v) => setHasta(v)} />
          </div>
          <div className="flex flex-col gap-1">
