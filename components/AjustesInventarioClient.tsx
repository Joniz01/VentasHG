...
export default function AjustesInventarioClient() {
  ...
  return (
    <div style={{ padding: "1.5rem", maxWidth: 860, display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                      ...
                      <div style={{
                        ...
                        <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
                          ...
                          <div style={{ display: "flex", flexDirection: "column", gap: 4, flex: "1 1 140px" }}>
                            ...
                            {stockPreview !== null && (
                              <span style={{
                                fontSize: "0.72rem", color: stockPreview < 0 ? "#b91c1c" : stockPreview === 0 ? "#B45309" : "#15803d",
                                fontWeight: 600,
                              }}>
                        ...
                        <div>
                          <button
                            ...
                            style={{
                              ...
                              borderRadius: 7, border: "none", cursor: aj.loading ? "wait" : "pointer",
      ...
      {/* Historial */}
      <div>
        <h2 style={{ margin: "0 0 0.75rem", fontSize: "0.875rem", fontWeight: 700, color: "var(--erp-text-2)" }}>
